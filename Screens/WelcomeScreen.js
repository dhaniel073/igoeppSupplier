...
import { NotificationUnread, SliderImage, SupplierUrl, TrendingService } from '../Utils/AuthRoute';
...
const WelcomeScreen = ({navigation}) => {
  ...
  const HideAmount = () => {
    authCtx.supplierShowAmount('hide')
  }
        ...
        <View style={{flexDirection:'row', justifyContent:'space-between', width:'100%'}}>
          ...
          <TouchableOpacity style={{flexDirection:'row', marginRight:3, justifyContent:'space-around'}} onPress={() => navigation.navigate('NotificationScreen')}>
            <View style={{marginRight:8}}>
              <FontAwesome name="bell" size={24} color={Color.darkolivegreen_100} />
            </View>
            <View>
