import { Alert, Keyboard, Platform, Pressable, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
...
import { BetPay, SupplierBillerCommission, SupplierUrl, ValidateBet, ValidatePin } from '../Utils/AuthRoute';
...
const Bet = ({navigation, route}) => {
  ...
  return (
    <ScrollView style={{marginTop:marginStyle.marginTp, marginHorizontal:10}} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.betpayment}>Bet</Text>
